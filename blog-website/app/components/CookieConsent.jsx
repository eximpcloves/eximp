...
import { getConsentState, acceptAllCookies, rejectNonEssentialCookies, saveCustomPreferences, getPreferences } from '../../lib/cookieConsent';
    ...
    <div style={styles.overlay}>
      <div style={styles.banner}>
        {!showSettings ? (
          <>
            <p style={styles.text}>
              We use cookies to make this site work and to remember things like your comment likes
              across visits. You can accept all cookies, reject non-essential ones, or choose exactly
          ...
          <>
            ...
            <div style={styles.settingRow}>
              <div>
                ...
                <div style={styles.settingDesc}>Remembers which posts you've already liked, across visits.</div>
              </div>
              <input
                type="checkbox"
            ...
            <div style={styles.settingRow}>
              <div>
                ...
                <div style={styles.settingDesc}>Helps us understand which posts are useful (if/when enabled).</div>
              </div>
              <input
                type="checkbox"
