...
const styles = {
  ...
  title: { fontFamily: 'Georgia, serif', fontSize: 'clamp(24px, 5vw, 40px)', lineHeight: 1.25, margin: '8px 0 10px', color: '#111', fontWeight: 700 },
  subtitle: { fontSize: 16, lineHeight: 1.7, color: '#555', margin: 0, maxWidth: 760 },
